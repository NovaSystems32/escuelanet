          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#f8f9fc] border-b border-[#d8e0ee]">
                ...
                <th className="text-left px-4 py-3 text-xs font-semibold text-[#5a6a8a] uppercase">Trimestre</th>
              ...
              {filtered.map(c => {
                ...
                return (
                  <tr key={c.id} className="hover:bg-[#f8f9fc]">
                    ...
                    <td className="px-4 py-3 text-sm text-[#5a6a8a] capitalize">{tipoOpts.find(t => t.value === c.tipo)?.label}</td>
                    <td className="px-4 py-3 text-sm text-[#5a6a8a]">{c.trimestre}°</td>
                    <td className="px-4 py-3 text-sm text-[#5a6a8a]">{new Date(c.fecha).toLocaleDateString('es-AR')}</td>
